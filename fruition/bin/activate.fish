...
set -gx VIRTUAL_ENV "/Users/olivialewandowski/Desktop/fruition/fruition"
...
if test -z "$VIRTUAL_ENV_DISABLE_PROMPT"
    ...
    function fish_prompt
        ...
        printf "%s%s%s" (set_color 4B8BBE) "(fruition) " (set_color normal)
    ...
    set -gx VIRTUAL_ENV_PROMPT "(fruition) "
end
...
if test -z "$NODE_VIRTUAL_ENV_DISABLE_PROMPT"
    ...
    function fish_prompt
        ...
        if test -n "(fruition)"
            printf '%s%s ' "(fruition)" (set_color normal)
        else
