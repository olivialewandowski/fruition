...
const AppliedTab = ({ projects, appliedProjects }: AppliedTabProps) => {
  // Use appliedProjects if provided, otherwise use projects
  const projectsToDisplay = appliedProjects || projects || [];
      ...
      {projectsToDisplay.length > 0 ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mt-2">
            Swipe up on projects in the Discover tab to apply!
          </p>
        </div>
      )}
    </div>
